    ...
    {
        public class MessageService(IMessageRepo _message ) : IMessageService
    {
        ...
        public async Task<GeneralResponse<IEnumerable<MessageRes>>> GetAllMessages(MessageReq model)
        {
            ...
            var r = await _message.GetMessagesForConversation(model.ConversationId, model.PageNumber, model.PageSize);
